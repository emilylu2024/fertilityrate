...
```{r}
fertility_rate<- read_csv("fertility_long.csv", show_col_types = FALSE)
marriage_rate <- read_csv("marriage-rate-per-1000-inhabitants.csv",
...
shapefile_path <-
  "/Users/jingjingdong/Desktop/geoBoundariesCGAZ_ADM0/geoBoundariesCGAZ_ADM0.shp"
...
```{r}
gdp <- read_csv("gdp_long.csv", show_col_types = FALSE)
```
...
```{r}
education <- read_csv("education_long.csv", show_col_types = FALSE)
...
```{r}
life_expectancy <- read_csv("life_long.csv", show_col_types = FALSE)
